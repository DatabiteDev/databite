...
├── src/
│   └── connectors/
│       ├── index.ts             # Main connector exports
│       ├── slack/               # Slack connector
│       │   └── index.ts         # Slack connector definition
│       └── trello/              # Trello connector
│           └── index.ts         # Trello connector definition
...
- **GitHub** - Code repository management (coming soon)
- **Salesforce** - CRM and sales automation (coming soon)
- **HubSpot** - Marketing and sales platform (coming soon)

Each connector includes:

- **Authentication Flow**: Built-in authentication using @databite/flow
...
```typescript
import trello from "@databite/connectors";
...
```typescript
// Create an integration
const trelloIntegration = trello.createIntegration(
